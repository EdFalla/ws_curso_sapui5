					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Free Style SAPUI5",
									"targetURL": "#freesapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"freesapui5-display": {
								"semanticObject": "freesapui5",
								"action": "display",
								"description": "A Free Style App SAPUI5",
								"title": "Free Style SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=freesapui5",
									"url": sap.ui.require.toUrl("freesapui5")
								}
							}
						}
					}
